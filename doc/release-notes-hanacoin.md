NFGcoin Core version *0.15.1* is now available from:
...
A number of changes to the way NFGcoin Core deals with peer connections and invalid blocks
...
The minimum relay fee `-minrelayfee` has been lowered to 0.01 mNfg per kB (0.00001 NFG). This is to prepare for dropping the minimum transaction fee to 0.1 mNFG per kB (0.0001 NFG) in the next release.
