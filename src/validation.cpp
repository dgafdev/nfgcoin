...
#if defined(NDEBUG)
# error "NFGcoin cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "NFGcoin Signed Message:\n";
                              ...
                              bool fOverrideMempoolLimit, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s NFG additional fees, %d delta bytes\n",
